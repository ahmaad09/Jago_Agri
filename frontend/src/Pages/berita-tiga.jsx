...
import BeritaDua from "../components/Elemets/Berita/Berita_dua";
import BeritaTiga from "../components/Elemets/Berita/Berita_tiga";
...
const Berita = () => {
    ...
    const newsToShow = cardData
        .filter((card) => card.id >= 13) // Filter hanya ID >= 2
