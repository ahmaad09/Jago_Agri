...
function MyCalendar() {
    ...
    const saveNote = () => {
        if (currentNote.trim() !== "") {
            ...
            const note = {
                ...
                month: value.toLocaleDateString('id-ID', { month: 'long' }),
                content: currentNote,
            };
            setNotes([...notes, note]);
            setCurrentNote(""); // Reset input catatan
    ...
    const deleteNote = (index) => {
        ...
        newNotes.splice(index, 1); // Hapus catatan berdasarkan index
        setNotes(newNotes);
    };
    ...
    return (
        <div className="flex">
            ...
            {/* Catatan */}
            <div className="ml-10 max-w-lg p-4 border border-gray-300 rounded-md shadow-sm flex-shrink-0 h-full w-full mt-20">
